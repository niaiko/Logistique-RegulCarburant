...
import mg.cnaps.repository.AssociationRepository;
...
public class AssociationServiceImpl implements AssociationService{
	...
	@Override
	public AssociationMod save(AssociationMod carb) {
		return repository.save(carb);
		
	}

	@Override
	public AssociationMod getById(Serializable id) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<AssociationMod> getAll(int page) {
		return (repository.findAll(new PageRequest(page-1,max))).getContent();
	}

	@Override
	public void delete(AssociationMod entity) {
	...
	@Override
	public List<AssociationMod> getAll() {
		// TODO Auto-generated method stub
		return null;
	}
